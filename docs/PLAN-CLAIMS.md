...
| ECO-01 | P1 | in_progress | 002（子代理） | 2026-09-07 14:0x | packages/autoflow-sdk + packages/autocodeflow-node-sdk + examples/ + docs/sdk-guide.md（admin-api/executor 两仓零改动；QA-07 contract.json append-only 不改） | | SDK 统一矩阵 + 官方示例（路线图 #10 收口） |
