...
| DEP-01 | P2 | in_progress | 004（子代理） | 2026-09-07 13:59 | admin-api application 模块独占（新 releases 聚合端点：service/controller/DTO/spec）+ docs/api-reference.md（小改即提交）。零迁移预案（纯读聚合视图）；若确需迁移用 >1789700000000 未占用号（1789700000000 为 002/ECO-01 预留，避开） | | /releases 统一资源 |
