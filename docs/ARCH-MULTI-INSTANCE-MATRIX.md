...
> 含灰度心跳跨实例 20/20、outbox 重复投递边界 13/13，2026-09-12~13）；
> **2026-09-26 Linux 开发机独立复跑**（docker 26.1.4 + PG16/Redis7 容器）：四套存档脚本
...
> 复验（2026-09-26 Linux 开发机）：四套脚本 `test:arch31-{multi-instance,rollout,outbox,outbox-dup}` 独立复跑 57/57 通过。
