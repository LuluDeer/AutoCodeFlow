  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/agent-sessions', icon: <RobotOutlined />, label: t('nav.agents') },
...
const ADMIN_ONLY_MENU_KEYS = new Set(['/executor-packages', '/audit', '/users', '/notifications', '/sops', '/agent-sessions']);
