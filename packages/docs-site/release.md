...
|----|--------|---------|-------------------|
| `@autocodeflow/sdk` | npm（scoped 公开包） | **1.3.0** | `packages/autocodeflow-node-sdk/package.json` |
| `autoflow-sdk` | PyPI | **1.3.0** | `packages/autoflow-sdk/pyproject.toml`（+ `autoflow_sdk.__version__`） |
| `autocodeflow-mcp-server` | npm | **1.3.0** | `packages/mcp-server/package.json` |
