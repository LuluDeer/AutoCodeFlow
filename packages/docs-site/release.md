...
|----|--------|---------|-------------------|
| `@autocodeflow/sdk` | npm（scoped 公开包） | **1.0.1** | `packages/autocodeflow-node-sdk/package.json` |
| `autoflow-sdk` | PyPI | **1.0.1** | `packages/autoflow-sdk/pyproject.toml`（+ `autoflow_sdk.__version__`） |
| `autocodeflow-mcp-server` | npm | **1.0.1** | `packages/mcp-server/package.json` |
